...
export default async function DashboardPage() {
  ...
  const [totalLeads, totalCampaigns, recentLogs, activeCampaigns] =
    await Promise.all([
  ...
  const statCards = [
    {
      ...
      icon: (
        <Profile2User size={24} color="var(--color-primary)" variant="Bold" />
      ),
    ...
    },
    {
      ...
      icon: (
        <MessageText size={24} color="var(--color-primary)" variant="Bold" />
      ),
    ...
    },
    {
      ...
      icon: <Send2 size={24} color="var(--color-primary)" variant="Bold" />,
      href: "/dashboard/campaigns",
    },
  ];

  return (
    <div style={{ padding: "0.75rem 2rem 2rem 2rem", maxWidth: "72rem" }}>
      <h1
        style={{
              ...
              activeCampaigns.map((c, i) => (
                <div
                  ...
                  style={{
                    ...
                    borderTop:
                      i > 0 ? "1px solid var(--color-outline-variant)" : "none",
                    display: "flex",
                    alignItems: "center",
                    gap: "0.75rem",
                  }}
