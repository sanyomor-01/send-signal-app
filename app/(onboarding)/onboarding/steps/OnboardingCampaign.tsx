    ...
    >
      <div style={{ flex: 1 }}>
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          <OnboardingProgress stepIndex={4} completedSteps={completedSteps} />
        </div>
          ...
          {[
            {
              ...
              value: data.whatsappAccountId ? "✅ Connected" : "⚠️ Not set",
              ok: !!data.whatsappAccountId,
            },
            {
              label: "Template",
              value: data.templateId ? "✅ Ready" : "⚠️ Not set",
              ok: !!data.templateId,
            },
            {
              label: "Recipients",
              value:
                recipientCount > 0 ? `${recipientCount} leads` : "⚠️ No leads",
              ok: recipientCount > 0,
            },
