...
export function OnboardingImport({ onNext, onBack, completedSteps }: Props) {
    ...
    >
      <div style={{ flex: 1 }}>
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          <OnboardingProgress stepIndex={2} completedSteps={completedSteps} />
        </div>
        ...
        >
          Upload a CSV file. At minimum, include a phone number column. Phone
          numbers will be validated and normalized to E.164 format.
        </p>
        ...
        <div style={{ display: "flex", gap: "1rem" }}>
          ...
          {!result ? (
            ...
            <Button
              id="import-next-btn"
              variant="primary"
              onClick={() => onNext({ importedLeadIds: result.leadIds })}
            >
