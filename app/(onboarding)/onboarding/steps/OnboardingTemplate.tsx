...
export function OnboardingTemplate({ onNext, onBack, completedSteps }: Props) {
    ...
    >
      <div style={{ flex: 1 }}>
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          <OnboardingProgress stepIndex={3} completedSteps={completedSteps} />
        </div>
        ...
        >
          Build a reusable message. Use placeholders like{" "}
          <code
            style={{
              ...
              {PLACEHOLDERS.map((ph) => (
                <button
                  ...
                  style={{
                    ...
                    border: "1px solid var(--color-outline-variant)",
                    backgroundColor: placeholders.includes(
                      ph.replace(/[{}]/g, ""),
                    )
                      ? "var(--color-primary-container)"
                      : "var(--color-surface-container)",
                    color: placeholders.includes(ph.replace(/[{}]/g, ""))
