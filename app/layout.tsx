...
export const metadata: Metadata = {
  ...
  description:
    "Scale your messaging with Send Signal. Import leads, create personalized templates, and automate your WhatsApp marketing campaigns securely using the official WhatsApp Business API.",
  keywords: [
    "WhatsApp outreach",
  ...
  openGraph: {
    title: "Send Signal | Automated & Personalized WhatsApp Outreach",
    description:
      "Import leads, create templates, and automate WhatsApp marketing campaigns securely.",
  ...
  twitter: {
    ...
    description:
      "Import leads, create templates, and automate WhatsApp marketing campaigns safely.",
