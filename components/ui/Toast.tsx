...
function getToastIcon(type: ToastType) {
  switch (type) {
    case "success":
      return <TickCircle size={16} color="currentColor" variant="Bold" />;
    case "error":
      return <CloseCircle size={16} color="currentColor" variant="Bold" />;
    case "warning":
      return <Warning2 size={16} color="currentColor" variant="Bold" />;
    case "info":
      return <InfoCircle size={16} color="currentColor" variant="Bold" />;
  }
}
